...
const WatchlistView = ({ watchlist, getWatchedMovies, getUnwatchedMovies, onRemove, onToggleWatched, language, onMovieClick }) => {
  ...
  return (
    <div className="space-y-10">
      ...
      {unwatched.length > 0 && (
        ...
        >
          <motion.h2
            ...
            className="text-3xl font-bold mb-6 bg-gradient-to-r from-orange-400 to-amber-300 bg-clip-text text-transparent"
          >
      ...
      {watched.length > 0 && (
        ...
        >
          <motion.h2
            initial={{ opacity: 0, x: -20 }}
            animate={{ opacity: 1, x: 0 }}
            className="text-3xl font-bold mb-6 bg-gradient-to-r from-amber-400 to-orange-400 bg-clip-text text-transparent"
          >
      ...
      >
        <h3 className="text-2xl font-bold mb-6 bg-gradient-to-r from-orange-400 via-amber-300 to-orange-500 bg-clip-text text-transparent">
          {getTranslation(language, 'statistics')}
        </h3>
        <div className="grid grid-cols-3 gap-6">
          <motion.div
            whileHover={{ scale: 1.05, y: -5 }}
            className="text-center p-6 bg-gray-900/50 rounded-lg border border-gray-700/50 hover:border-orange-500/50 transition-all"
          >
            <p className="text-4xl font-bold bg-gradient-to-r from-orange-500 to-amber-400 bg-clip-text text-transparent">
              {watchlist.length}
            </p>
          ...
          <motion.div
            whileHover={{ scale: 1.05, y: -5 }}
            className="text-center p-6 bg-gray-900/50 rounded-lg border border-gray-700/50 hover:border-amber-500/50 transition-all"
          >
            <p className="text-4xl font-bold bg-gradient-to-r from-amber-500 to-amber-400 bg-clip-text text-transparent">
              {watched.length}
            </p>
          ...
          <motion.div
            ...
            className="text-center p-6 bg-gray-900/50 rounded-lg border border-gray-700/50 hover:border-orange-500/50 transition-all"
          >
            <p className="text-4xl font-bold bg-gradient-to-r from-orange-500 to-orange-400 bg-clip-text text-transparent">
              {unwatched.length}
            </p>
